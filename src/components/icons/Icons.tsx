...
export const StarIcon = ({ className = 'star-icon' }: IconProps) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export const PauseIcon = ({ width = 14, height = 14 }: IconProps) => (
  <svg
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
...
export const PlayIcon = ({ width = 14, height = 14 }: IconProps) => (
  <svg
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
